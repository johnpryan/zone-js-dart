...
@anonymous
@JS("Zone")
abstract class ZoneInterface {
  external ZoneInterface get parent;
  external set parent(ZoneInterface v);
  ...
  external ZoneInterface getZoneWith(String key);

  /// Used to create a child zone.
  external ZoneInterface fork(ZoneSpec zoneSpec);
  ...
  external dynamic/*=F*/ wrap/*<F extends Function>*/(
      dynamic/*=F*/ callback, String source);

  /// Invokes a function in a given zone.
  /// The invocation of `callback` can be intercepted be declaring [ZoneSpec.onInvoke].
  external dynamic/*=T*/ run/*<T>*/(Function callback,
      [dynamic applyThis, List<dynamic> applyArgs, String source]);
  ...
  external dynamic/*=T*/ runGuarded/*<T>*/(Function callback,
      [dynamic applyThis, List<dynamic> applyArgs, String source]);

  /// Execute the Task by restoring the [Zone.currentTask] in the Task's zone.
  external dynamic runTask(Task task, [dynamic applyThis, dynamic applyArgs]);
  external MicroTask scheduleMicroTask(String source, Function callback,
      [TaskData data, void customSchedule(Task task)]);
  external MacroTask scheduleMacroTask(
      String source,
      Function callback,
      TaskData data,
      void customSchedule(Task task),
      void customCancel(Task task));
  external EventTask scheduleEventTask(
      String source,
      Function callback,
      TaskData data,
      void customSchedule(Task task),
  ...
  /// the [Task.cancelFn].
  external dynamic cancelTask(Task task);
}
...
abstract class ZoneType {
  ...
  external ZoneInterface get current;
  external set current(ZoneInterface v);
  external Task get currentTask;
  external set currentTask(Task v);

  /// Verify that Zone has been correctly patched. Specifically that Promise is zone aware.
  external dynamic assertZonePatched();
}
...
abstract class ZoneSpec {
  ...
  external dynamic /*JSMap of <String,dynamic>*/ get properties;
  external set properties(dynamic /*JSMap of <String,dynamic>*/ v);

  /// Allows the interception of zone forking.
  /// When the zone is being forked, the request is forwarded to this method for interception.
  external Func4<ZoneDelegate, ZoneInterface, ZoneInterface, ZoneSpec, ZoneInterface> get onFork;
  external set onFork(Func4<ZoneDelegate, ZoneInterface, ZoneInterface, ZoneSpec, ZoneInterface> v);

  /// Allows interception of the wrapping of the callback.
  external Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, delegate: Function, source: string) => Function*/ get onIntercept;
  external set onIntercept(
      Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, delegate: Function, source: string) => Function*/ v);

  /// Allows interception of the callback invocation.
  external Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, delegate: Function, applyThis: any, applyArgs: any[], source: string) => any*/ get onInvoke;
  external set onInvoke(
      Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, delegate: Function, applyThis: any, applyArgs: any[], source: string) => any*/ v);

  /// Allows interception of the error handling.
  external Func4<ZoneDelegate, ZoneInterface, ZoneInterface, dynamic, bool> get onHandleError;
  external set onHandleError(Func4<ZoneDelegate, ZoneInterface, ZoneInterface, dynamic, bool> v);

  /// Allows interception of task scheduling.
  external Func4<ZoneDelegate, ZoneInterface, ZoneInterface, Task, Task> get onScheduleTask;
  external set onScheduleTask(Func4<ZoneDelegate, ZoneInterface, ZoneInterface, Task, Task> v);
  external Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, task: Task, applyThis: any, applyArgs: any) => any*/ get onInvokeTask;
  external set onInvokeTask(
      Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, task: Task, applyThis: any, applyArgs: any) => any*/ v);

  /// Allows interception of task cancelation.
  external Func4<ZoneDelegate, ZoneInterface, ZoneInterface, Task, dynamic> get onCancelTask;
  external set onCancelTask(Func4<ZoneDelegate, ZoneInterface, ZoneInterface, Task, dynamic> v);

  /// Notifies of changes to the task queue empty status.
  external VoidFunc4<ZoneDelegate, ZoneInterface, ZoneInterface, HasTaskState> get onHasTask;
  external set onHasTask(VoidFunc4<ZoneDelegate, ZoneInterface, ZoneInterface, HasTaskState> v);
  external factory ZoneSpec(
      {String name,
      dynamic /*JSMap of <String,dynamic>*/ properties,
      Func4<ZoneDelegate, ZoneInterface, ZoneInterface, ZoneSpec, ZoneInterface> onFork,
      Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, delegate: Function, source: string) => Function*/ onIntercept,
      Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, delegate: Function, applyThis: any, applyArgs: any[], source: string) => any*/ onInvoke,
      Func4<ZoneDelegate, ZoneInterface, ZoneInterface, dynamic, bool> onHandleError,
      Func4<ZoneDelegate, ZoneInterface, ZoneInterface, Task, Task> onScheduleTask,
      Function /*(parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, task: Task, applyThis: any, applyArgs: any) => any*/ onInvokeTask,
      Func4<ZoneDelegate, ZoneInterface, ZoneInterface, Task, dynamic> onCancelTask,
      VoidFunc4<ZoneDelegate, ZoneInterface, ZoneInterface, HasTaskState> onHasTask});
}
...
abstract class ZoneDelegate {
  external ZoneInterface get zone;
  external set zone(ZoneInterface v);
  external ZoneInterface fork(ZoneInterface targetZone, ZoneSpec zoneSpec);
  external Function intercept(
      ZoneInterface targetZone, Function callback, String source);
  external dynamic invoke(ZoneInterface targetZone, Function callback, dynamic applyThis,
      List<dynamic> applyArgs, String source);
  external bool handleError(ZoneInterface targetZone, dynamic error);
  external Task scheduleTask(ZoneInterface targetZone, Task task);
  external dynamic invokeTask(
      ZoneInterface targetZone, Task task, dynamic applyThis, dynamic applyArgs);
  external dynamic cancelTask(ZoneInterface targetZone, Task task);
  external void hasTask(ZoneInterface targetZone, HasTaskState isEmpty);
}

@anonymous
@JS()
abstract class HasTaskState {
  external bool get microTask;
  external set microTask(bool v);
  external bool get macroTask;
  external set macroTask(bool v);
  external bool get eventTask;
  external set eventTask(bool v);
  external String get change;
  external set change(String v);
  external factory HasTaskState(
      {bool microTask, bool macroTask, bool eventTask, String change});
}
...
abstract class TaskData {
  ...
  external bool get isPeriodic;
  external set isPeriodic(bool v);
  ...
  external num get handleId;
  external set handleId(num v);
  external factory TaskData({bool isPeriodic, num delay, num handleId});
}
...
abstract class Task {
  ...
  external Function get invoke;
  external set invoke(Function v);
  ...
  external TaskData get data;
  external set data(TaskData v);
  ...
  external VoidFunc1<Task> get scheduleFn;
  external set scheduleFn(VoidFunc1<Task> v);
  ...
  /// A zone may chose to intercept this function and perform its own scheduling.
  external VoidFunc1<Task> get cancelFn;
  external set cancelFn(VoidFunc1<Task> v);
  ...
  external num get runCount;
  external set runCount(num v);
  external factory Task(
      ...
      Function callback,
      TaskData data,
      VoidFunc1<Task> scheduleFn,
      VoidFunc1<Task> cancelFn,
      ZoneInterface zone,
      num runCount});
}
...
@anonymous
@JS()
abstract class MicroTask implements Task {
  external factory MicroTask(
      {String type,
      String source,
      Function invoke,
      Function callback,
...
@anonymous
@JS()
abstract class MacroTask implements Task {
  external factory MacroTask(
      {String type,
      String source,
      Function invoke,
      Function callback,
...
abstract class Error {
  ...
  external String get zoneAwareStack;
  external set zoneAwareStack(String v);

  /// Original stack trace with no modiffications
  external String get originalStack;
  external set originalStack(String v);
  external factory Error(
      {String name,
      String message,
      String zoneAwareStack,
      String originalStack});
}

@JS()
external ZoneType get Zone;
